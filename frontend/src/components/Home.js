...
const Home = ({ shoes, onSelectShoe }) => {
    ...
    const parallelogramStyle = {
        ...
        width: "150vw", // Makes it relative to the viewport width
        height: "100vh", // Relative to viewport height
        background: "linear-gradient(to bottom, #16202c 0%, #1f2d47 100%)",
        transform: "translateX(-50vw) skew(20deg)", // Initial position relative to viewport
    ...
    @keyframes slide-inhome {
        from {
            transform: translateX(-135vw) translateY(-50vh) skew(40deg);
        }
        to {
            transform: translateX(-195vw) translateY(-50vh) skew(40deg);
        }
    }`;
            ...
            >
                ...
                <div
                    style={{
                        ...
                        right: 0,
                        bottom: 0,
                        background: "linear-gradient(to bottom,rgb(14, 18, 23) 0%,rgb(33, 39, 51) 100%)",
                        zIndex: -1,
                ...
                <div>
                    ...
                    <div style={parallelogramStyle} onAnimationEnd={() => setZIndex(1)}></div>
                </div>
                <div style={{ zIndex: "-1" }}>
                    <div
                        style={{
                    ...
                    <div
                        style={{
                            ...
                            boxShadow: "0px 20px 50px rgba(0, 0, 0, 0.2)", // Subtle shadow
                            transition: "transform 0.5s ease",
                            transform: `translate(${scrollPosition * 0.6}px, ${scrollPosition * 0.6}px) rotate(-45deg)translateY(200px)translateX(-120px)`,
                        }}
                    />
                    <div
                        style={{
                    ...
                    <div
                        style={{
                            ...
                            transform: `translate(-${scrollPosition * 0.6}px, -${scrollPosition * 0.6}px) rotate(45deg) translateY(-300px) translateX(25px) `,
                        }}
